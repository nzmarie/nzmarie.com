...
function TownhousePageContent() {
  ...
  const analysisMessages = [
    "Mapping 2026 lending criteria impact on townhouse valuations...",
    "Correlating yield benchmarks & cash flow potential for your enclave...",
    "Compiling comparative townhouse market intelligence model...",
  ];
    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col selection:bg-amber-500/30 selection:text-amber-200">
      ...
      <section className="relative min-h-[90vh] flex items-center pt-32 pb-20 px-6 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/townhouse_enclave.png"
            alt="Modern Auckland Townhouse Enclave at Twilight"
            fill
            priority
            className="object-cover object-center lg:object-right opacity-85 brightness-[0.88] contrast-[1.05] saturate-[1.1]"
          />
                ...
                >
                  ...
                  <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-6 leading-[1.1] max-w-3xl">
                    ...
                    <span className="bg-gradient-to-r from-amber-200 via-amber-400 to-amber-500 bg-clip-text text-transparent">
                      Expert Analysis for Your Townhouse Enclave.
                    </span>
                  </h1>
                  ...
                  <form onSubmit={handleStartAnalysis} className="w-full max-w-2xl relative mb-12" ref={dropdownRef}>
                    <div className="flex flex-col sm:flex-row items-stretch gap-3 p-2.5 rounded-2xl bg-slate-900/90 backdrop-blur-md border border-white/10 shadow-2xl focus-within:border-amber-400/50 transition-colors">
                      <div className="relative flex-1 flex items-center min-h-[50px] px-3">
                        ...
                        <input
                          type="text"
                          placeholder="Enter your townhouse address (e.g., 2 Chelsea Lane)..."
                          value={addressQuery}
                          onChange={(e) => {
              ...
              {funnelStep === "success" && (
                ...
                >
                  ...
                  <p className="text-sm text-slate-400 text-center mb-8 leading-relaxed">
                    Thank you, {leadName}. Your custom townhouse appraisal for <strong className="text-white">{selectedAddress || addressQuery}</strong> is being formulated. I will email the report within 24 hours.
                  </p>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="font-serif text-3xl sm:text-4xl font-bold tracking-tight mb-4">
              Why Townhouse Sellers Need a Smarter Strategy?
            </h2>
            <p className="text-base text-slate-600 font-light">
              Townhouse markets are driven by lending criteria changes and yield compression. I leverage macro-economic data to position your property for maximum cash flow returns.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
            <div className="flex flex-col items-start p-6 sm:p-8 rounded-2xl border border-slate-100 hover:border-slate-200 hover:shadow-xl transition-all">
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                ...
                <h3 className="font-serif text-lg sm:text-xl font-bold text-slate-900">2026 Lending Criteria</h3>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed font-light">
                Tracking RBNZ LVR restrictions, debt-to-income rules, and buyer borrowing capacity shifts that directly affect townhouse demand and pricing.
              </p>
            </div>
            ...
            <div className="flex flex-col items-start p-6 sm:p-8 rounded-2xl border border-slate-100 hover:border-slate-200 hover:shadow-xl transition-all">
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                ...
                <h3 className="font-serif text-lg sm:text-xl font-bold text-slate-900">Yield &amp; Cash Flow Analysis</h3>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed font-light">
                Modeling gross and net rental yields, vacancy rate trends, and cash flow projections to position your townhouse for both investors and owner-occupiers.
              </p>
            </div>
            ...
            <div className="flex flex-col items-start p-6 sm:p-8 rounded-2xl border border-slate-100 hover:border-slate-200 hover:shadow-xl transition-all">
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                ...
                <h3 className="font-serif text-lg sm:text-xl font-bold text-slate-900">Enclave Positioning</h3>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed font-light">
                Benchmarking your unit against comparable enclaves, body corporate structures, and lot-specific premiums to sharpen your negotiation position.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="space-y-4 text-xs text-slate-600 font-light leading-relaxed">
            ...
            <p className="pt-4 text-slate-700">
              &copy; {new Date().getFullYear()} NZ Marie Real Estate. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
