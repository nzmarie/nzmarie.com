            ...
            <table className="w-full text-left text-sm text-gray-600 min-w-max">
              <thead className="bg-slate-50 border-b border-gray-200 text-xs font-bold uppercase text-slate-500">
                <tr>
                  ...
                  <th className="px-4 py-3">Quarter / Year</th>
                    ...
                    <Fragment key={key}>
                      ...
                      {items.map((item) => (
                        <tr key={item.id} className="hover:bg-slate-50 transition-colors">
                          <td className="px-4 py-4 font-semibold text-gray-900 whitespace-nowrap">{item.suburb}</td>
                          ...
                          <td className="px-4 py-4">
                            <div className="font-medium text-gray-900 truncate max-w-sm" title={item.file_name}>{item.file_name}</div>
                          ...
                          <td className="px-4 py-4 text-center font-medium text-gray-800 whitespace-nowrap">{item.download_count ?? 0}</td>
                          ...
                          <td className="px-4 py-4 text-right whitespace-nowrap">
                            <div className="flex items-center justify-end gap-1">
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center justify-center w-8 h-8 text-blue-600 hover:text-blue-800 bg-blue-50 hover:bg-blue-100 rounded-md transition-colors"
                                title="View PDF"
                              >
                              ...
                              <button
                                ...
                                className="inline-flex items-center justify-center w-8 h-8 text-red-600 hover:text-red-800 bg-red-50 hover:bg-red-100 rounded-md transition-colors cursor-pointer"
