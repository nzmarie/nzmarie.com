...
SET content = jsonb_build_array(
    jsonb_build_object('type', 'paragraph', 'content', jsonb_build_array('Dear Neighbour,')),
    ...
    jsonb_build_object('type', 'paragraph', 'content', jsonb_build_array('Barfoot & Thompson (Licensed REAA 2008)')),
    jsonb_build_object('type', 'paragraph', 'content', jsonb_build_array('📱 021 069 3089')),
    jsonb_build_object('type', 'paragraph', 'content', jsonb_build_array('📧 m.nian@barfoot.co.nz')),
    jsonb_build_object('type', 'paragraph', 'content', jsonb_build_array('🌐 www.nzmarie.com'))
  )
