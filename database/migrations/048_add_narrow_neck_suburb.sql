-- Add Narrow Neck to report_suburbs between Bayswater (36) and Devonport,
-- following the priority order in lib/suburb-order.ts, and seed its
-- introduction, letter and quarterly report (same pattern as 022/027/044/047).

INSERT INTO report_suburbs (name, region, sort_order, is_active)
VALUES
  ('Narrow Neck', 'North Shore', 37, TRUE),
  ('Devonport', 'North Shore', 38, TRUE),
  ('Stanley Point', 'North Shore', 39, TRUE)
